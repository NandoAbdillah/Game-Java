...
/**
 * Mengelola semua benda hidup (Player, Musuh, NPC).
 * Menggunakan "Safe Removal" agar tidak crash saat menghapus musuh yang mati di tengah loop.
 */
public class EntityManager {
    ...
    public void removeEntity(Entity entity) {
        // Jangan langsung dihapus, masukkan antrean agar loop update tidak rusak
